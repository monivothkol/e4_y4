document.addEventListener("DOMContentLoaded", function() {
    ...
    <header class="sticky-header">
        <div class="logo-container">
            <a href="../e4_y4/src/index.html"><img src="../e4_y4/src/assets/logo.png" alt="Logo" class="logo"></a>
        </div>
        <nav class="navbar">
            <a href="../e4_y4/src/index.html" class="nav-text">Home</a>
            <div class="dropdown">
                <a href="#" class="nav-text dropbtn">Products</a>
                <div class="dropdown-content">
                    <a href="../e4_y4/src/html/Networking.html">Network</a>
                    <a href="../e4_y4/src/html/Storage.html">Storage</a>
                    <a href="../e4_y4/src/html/Electronic.html">Computers</a>
                </div>
            </div>
            <div class="dropdown">
                <a href="#" class="nav-text dropbtn">Services</a>
                <div class="dropdown-content">
                    <a href="../e4_y4/src/html/personal_service.html">Personal Use</a>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="../e4_y4/src/html/about.html">Our Company</a>
                    <a href="../e4_y4/src/html/partner.html">Our Partners</a>
                    <a href="../e4_y4/src/html/client.html">Our Clients</a>
                </div>
            </div>
            <a href="../e4_y4/src/html/contact.html" class="nav-text">Contact</a>
        </nav>
    ...
    const footerHTML = `
      ...
      <div class="footer-container">
        <div class="footer-section logo-section">
          <a href="index.html"><img src="../e4_y4/src/assets/logo.png" alt="Logo" class="logo"></a>
