document.addEventListener("DOMContentLoaded", function() {
    ...
    <header class="sticky-header">
        <div class="logo-container">
            <a href="../src/index.html"><img src="../assets/logo.png" alt="Logo" class="logo"></a>
        </div>
        <nav class="navbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="../html/Networking.html">Network</a>
                    <a href="../html/Storage.html">Storage</a>
                    <a href="../html/Electronic.html">Computers</a>
                </div>
            </div>
            <div class="dropdown">
                <a href="#" class="nav-text dropbtn">Services</a>
                <div class="dropdown-content">
                    <a href="../html/personal_service.html">Personal Use</a>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="../html/about.html">Our Company</a>
                    <a href="../html/partner.html">Our Partners</a>
                    <a href="../html/client.html">Our Clients</a>
                </div>
            </div>
            <a href="../html/contact.html" class="nav-text">Contact</a>
        </nav>
